...
set "COMANDO_FILE=%ROOT_DIR%\comando\COMANDO_VENCIMENTO_PAGAMENTOS.csv"
...
if errorlevel 1 (
    echo.
    echo ERRO na execucao do projeto COMANDO_VENCIMENTO_PAGAMENTOS
) else (
    echo.
    echo Projeto COMANDO_VENCIMENTO_PAGAMENTOS gerado com sucesso.
)
endlocal
@pause
