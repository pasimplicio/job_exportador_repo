...
WHERE
	...
	--AND imo.imov_id = 19
	AND con_atraso.qtd >=60
	AND NOT EXISTS (SELECT pag5.pgmt_id FROM arrecadacao.pagamento pag5 WHERE pag5.imov_id = imo.imov_id)
	AND NOT EXISTS (SELECT pag5.pghi_id FROM arrecadacao.pagamento_historico pag5 WHERE pag5.imov_id = imo.imov_id)
