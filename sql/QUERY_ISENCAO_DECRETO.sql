--202005: Deve ser substituida pela referencia do faturamento que se deseja obter os dados
...
SELECT 
	...
	con_ult_fat.cagua AS "VOL AG 202005",
	TO_CHAR(con_ult_fat.vl_agua, '999G999G990D00') AS "VL AG 202005",
	con_ult_fat.cesg AS "VOL ES 202005",
	TO_CHAR(con_ult_fat.vl_esgoto, '999G999G990D00') AS "VL ES 202005",
	TO_CHAR(con_ult_fat.vl_debitos, '999G999G990D00') AS "OUTROS SERVICOS 202005",
	TO_CHAR(con_ult_fat.vl_creditos, '999G999G990D00') AS "CRED 202005",
	TO_CHAR(con_ult_fat.vl_impostos, '999G999G990D00') AS "IMPOSTOS 202005",
	TO_CHAR(con_ult_fat.valor, '999G999G990D00') AS "VALOR 202005",
	con_pen_fat.cagua AS "VOL AG 202005 - 1",
	TO_CHAR(con_pen_fat.vl_agua, '999G999G990D00') AS "VL AG 202005 - 1",
	con_pen_fat.cesg AS "VOL ES 202005 - 1",
	TO_CHAR(con_pen_fat.vl_esgoto, '999G999G990D00') AS "VL ES 202005 - 1",
	TO_CHAR(con_pen_fat.vl_debitos, '999G999G990D00') AS "OUTROS SERVICOS 202005 - 1",
	TO_CHAR(con_pen_fat.vl_creditos, '999G999G990D00') AS "CRED 202005 - 1",
	TO_CHAR(con_pen_fat.vl_impostos, '999G999G990D00') AS "IMPOSTOS 202005 - 1",
	TO_CHAR(con_pen_fat.valor, '999G999G990D00') AS "VALOR 202005 - 1",
	con_ant_fat.cagua AS "VOL AG 202005 - 2",
	TO_CHAR(con_ant_fat.vl_agua, '999G999G990D00') AS "VL AG 202005 - 2",
	con_ant_fat.cesg AS "VOL ES 202005 - 2",
	TO_CHAR(con_ant_fat.vl_esgoto, '999G999G990D00') AS "VL ES 202005 - 2",
	TO_CHAR(con_ant_fat.vl_debitos, '999G999G990D00') AS "OUTROS SERVICOS 202005 - 2",
	TO_CHAR(con_ant_fat.vl_creditos, '999G999G990D00') AS "CRED 202005 - 2",
	TO_CHAR(con_ant_fat.vl_impostos, '999G999G990D00') AS "IMPOSTOS 202005 - 2",
	TO_CHAR(con_ant_fat.valor, '999G999G990D00') AS "VALOR 202005 - 2",
	...
	TO_CHAR(con_revisao_decreto_04.valor, '999G999G990D00') AS "VALOR TOTAL ISENTO 202004",
	TO_CHAR(con_revisao_decreto_04.outros, '999G999G990D00') AS "VALOR SERVICOS ADIADO 202004",
	TO_CHAR(con_revisao_decreto_04.creditos, '999G999G990D00') AS "VALOR CREDITOS ADIADO 202004",
	con_revisao_decreto_04.qtd AS "QTD. CONTAS INSENTO 202004",
	con_revisao_decreto_04.min AS "MENOR REFERENCIA ISENTA 202004",
	con_revisao_decreto_04.max AS "MAIOR REFERENCIA ISENTA 202004",
	TO_CHAR(con_revisao_decreto_05.valor, '999G999G990D00') AS "VALOR TOTAL ISENTO 202005",
	TO_CHAR(con_revisao_decreto_05.outros, '999G999G990D00') AS "VALOR SERVICOS ADIADO 202005",
	TO_CHAR(con_revisao_decreto_05.creditos, '999G999G990D00') AS "VALOR CREDITOS ADIADO 202005",
	con_revisao_decreto_05.qtd AS "QTD. CONTAS INSENTO 202005",
	con_revisao_decreto_05.min AS "MENOR REFERENCIA ISENTA 202005",
	con_revisao_decreto_05.max AS "MAIOR REFERENCIA ISENTA 202005",
	...
	TO_CHAR(pags_ult.valor, '999G999G990D00') AS "VALOR PAGO 202005",
	pags_ult.qtd AS "QTD DOC PAGOS 202005",
	TO_CHAR(pags_pen.valor, '999G999G990D00') AS "VALOR PAGO 202005 - 1",
	pags_pen.qtd AS "QTD DOC PAGOS 202005 - 1",
	TO_CHAR(pags_ant.valor, '999G999G990D00') AS "VALOR PAGO 202005 - 2",
	pags_ant.qtd AS "QTD DOC PAGOS 202005 - 2"
FROM 
	cadastro.imovel imo
	...
	LEFT JOIN cadastro.cliente_tipo clt2 ON clt2.cltp_id = cli2.cltp_id
	LEFT JOIN cadastro.cliente cli3 ON cli3.clie_id = cli2.clie_cdclienteresponsavel
	LEFT JOIN cadastro.cliente_tipo clt3 ON clt3.cltp_id = cli3.cltp_id
	...
	LEFT JOIN micromedicao.consumo_historico cosh_a1 ON cosh_a1.imov_id = imo.imov_id AND cosh_a1.cshi_amfaturamento = 202005 AND cosh_a1.lgti_id = 1
	...
	LEFT JOIN micromedicao.medicao_historico mdh ON mdh.hidi_id = his.hidi_id AND mdh.mdhi_amleitura = 202005
	...
	LEFT JOIN (	SELECT 
			...
			FROM faturamento.conta con4 
			WHERE 
				con4.dcst_idatual IN (0,1,2) AND NOT EXISTS ( SELECT pag.cnta_id FROM arrecadacao.pagamento pag WHERE pag.cnta_id = con4.cnta_id) AND NOT con4.cnta_dtrevisao IS NULL AND con4.cmrv_id = 114 AND con4.cnta_amreferenciaconta = 202004
			GROUP BY 1) AS con_revisao_decreto_04 ON con_revisao_decreto_04.mat1 = imo.imov_id
	LEFT JOIN (	SELECT 
				con4.imov_id AS mat1,
				COUNT(con4.cnta_id) AS qtd,
				MIN(con4.cnta_amreferenciaconta) AS min,
			...
			FROM faturamento.conta con4 
			WHERE 
				con4.dcst_idatual IN (0,1,2) AND NOT EXISTS ( SELECT pag.cnta_id FROM arrecadacao.pagamento pag WHERE pag.cnta_id = con4.cnta_id) AND NOT con4.cnta_dtrevisao IS NULL AND con4.cmrv_id = 114 AND con4.cnta_amreferenciaconta = 202005
			GROUP BY 1) AS con_revisao_decreto_05 ON con_revisao_decreto_05.mat1 = imo.imov_id
	LEFT JOIN (	SELECT 
				con4.imov_id AS mat1,
	...
	LEFT JOIN (	SELECT 
			...
			WHERE
				con4.cnta_amreferenciaconta = 202005
			UNION
			SELECT 
				con4.imov_id AS mat1,
			...
			FROM faturamento.conta_historico con4 
				INNER JOIN faturamento.conta_impressao cni ON cni.cnta_id = con4.cnta_id
			WHERE
				con4.cnhi_amreferenciaconta = 202005
	...
	LEFT JOIN (	SELECT 
			...
			WHERE
				con4.cnta_amreferenciaconta = (
					SELECT 
						CASE (CAST(SUBSTRING(CAST(202005 AS TEXT) FROM 5 FOR 6) AS INT))
							WHEN 1 THEN CAST((CAST(SUBSTRING(CAST(202005 AS TEXT) FROM 0 FOR 5) AS INT))-1 AS TEXT)||'VAR_UNIDADE'
							ELSE CAST(202005-1 AS TEXT)
						END
				)
			UNION
			SELECT 
	...
	LEFT JOIN (	SELECT 
			...
			WHERE
				con4.cnta_amreferenciaconta = (
					SELECT 
						CASE (CAST(SUBSTRING(CAST(202005 AS TEXT) FROM 5 FOR 6) AS INT))
							WHEN 1 THEN CAST((CAST(SUBSTRING(CAST(202005 AS TEXT) FROM 0 FOR 5) AS INT))-1 AS TEXT)||'11'
							WHEN 2 THEN CAST((CAST(SUBSTRING(CAST(202005 AS TEXT) FROM 0 FOR 5) AS INT))-1 AS TEXT)||'VAR_UNIDADE'
							ELSE CAST(202005-2 AS TEXT)
						END
				)
			UNION
			SELECT 
			...
			FROM		
				(SELECT 
					...
					FROM
						...
						INNER JOIN cadastro.localidade loc ON loc.loca_id = pag.loca_id
					WHERE
						pag.pgst_idatual IN (0,1)
						AND pag.pgmt_amreferenciaarrecadacao = 202005
					GROUP BY 1
				UNION
					SELECT 
						pag.imov_id AS imov_id,
					...
					WHERE
						pag.pgst_idatual IN (0,1)
						AND pag.pghi_amreferenciaarrecadacao = 202005
					GROUP BY 1) pags
			GROUP BY 1
...
WHERE
	...
	--AND une.uneg_id = VAR_UNIDADE
	--AND imo.imov_id = 19
	AND (con_revisao_decreto_05.valor > 0 OR con_revisao_decreto_04.valor > 0)
