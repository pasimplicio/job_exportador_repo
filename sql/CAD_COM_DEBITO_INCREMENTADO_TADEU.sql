...
SELECT 
	...
	imo.imov_nncoordenadax AS "COORDENADA X",
	imo.imov_nncoordenaday AS "COORDENADA Y",
	...
	con_ult_fat.cagua AS "VOL AG ULT FATURAMENTO",
	con_ult_fat.vl_agua AS "VL AG ULT FATURAMENTO",
	con_ult_fat.cesg AS "VOL ES ULT FATURAMENTO",
	con_ult_fat.vl_esgoto AS "VL ES ULT FATURAMENTO",
	con_ult_fat.vl_debitos AS "OUTROS SERVICOS ULT FATURAMENTO",
	con_ult_fat.vl_creditos AS "CRED ULT FATURAMENTO",
	con_ult_fat.vl_impostos AS "IMPOSTOS ULT FATURAMENTO",
	con_ult_fat.valor AS "VALOR ULT FATURAMENTO",
	...
	con_cobranca.vl_agua AS "VALOR AGUA EMP COB",
	con_cobranca.vl_esgoto AS "VALOR ESGOTO EMP COB",
	con_cobranca.vl_debitos AS "VALOR DEBITOS EMP COB",
	con_cobranca.vl_creditos AS "VALOR CREDITOS EMP COB",
	con_cobranca.vl_impostos AS "VALOR IMPOSTOS EMP COB",
	con_cobranca.valor AS "VALOR TOTAL EMP COB",
	...
	con_revisao_decreto.valor AS "VALOR TOTAL ISENTO",
	con_revisao_decreto.outros AS "VALOR SERVICOS ADIADO",
	con_revisao_decreto.creditos AS "VALOR CREDITOS ADIADO",
	...
	pags_ult.valor AS "VALOR PAGO ${VAR_REFERENCIA}",
	pags_ult.qtd AS "QTD DOC PAGOS ${VAR_REFERENCIA}",
	pags_pen.valor AS "VALOR PAGO ${VAR_REFERENCIA} - 1",
	pags_pen.qtd AS "QTD DOC PAGOS ${VAR_REFERENCIA} - 1",
	pags_ant.valor AS "VALOR PAGO ${VAR_REFERENCIA} - 2",
	pags_ant.qtd AS "QTD DOC PAGOS ${VAR_REFERENCIA} - 2"
FROM 
	cadastro.imovel imo
