	...
	WHERE
		con.cnhi_dtvencimentooriginal >= '2021-01-01' AND con.cnhi_dtvencimentooriginal <= '2021-01-31'
UNION
	SELECT
		imo.imov_id AS "MATRICULA",
		cli.clie_nmcliente AS "NOME",
...
UNION
	...
	FROM
		...
		LEFT JOIN faturamento.faturamento_grupo ftg ON rot.ftgr_id = ftg.ftgr_id
	WHERE
		con.cnta_dtvencimentooriginal >= '2021-01-01' AND con.cnta_dtvencimentooriginal <= '2021-01-31'
UNION
	SELECT
		imo.imov_id AS "MATRICULA",
		cli.clie_nmcliente AS "NOME",
...
UNION
	...
	FROM
		...
		LEFT JOIN faturamento.faturamento_grupo ftg ON rot.ftgr_id = ftg.ftgr_id
	WHERE
		con.cnta_dtvencimentooriginal >= '2021-01-01' AND 
		...
		AND con.cnta_dtvencimentooriginal <= '2021-01-31'
	UNION
	SELECT
		imo.imov_id AS "MATRICULA",
		cli.clie_nmcliente AS "NOME",
...
UNION
	...
	FROM
		...
		LEFT JOIN faturamento.faturamento_grupo ftg ON rot.ftgr_id = ftg.ftgr_id
	WHERE
		con.cnhi_dtvencimentooriginal >= '2021-01-01' AND con.cnhi_dtvencimentooriginal <= '2021-01-31' AND 
		con.dcst_idatual = 5