...
SELECT 
	...
	mdh.mdhi_tmultimaalteracao AS "Leitura Ultima Alteracao",
...
FROM 
	...
	INNER JOIN cadastro.gerencia_regional gre ON loc.greg_id = gre.greg_id
...
WHERE
	imo.imov_icexclusao = 2 AND con_ult_fat.valor>0 AND gre.greg_id IN(1, 2) --AND imo.imov_id = 922137
ORDER BY "Matricula"