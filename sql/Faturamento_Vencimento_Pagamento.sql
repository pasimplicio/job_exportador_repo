...
SELECT 
	...
	pag_referencia."PERFIL" AS "PERFIL",
	TO_CHAR(con_ult_fat.valor, '999G999G990D00') AS "VALOR",
	pag_referencia."REFERENCIA" AS "REFERENCIA",
	TO_CHAR(pag_referencia."DATA PAGAMENTO", 'DD/MM/YYYY') AS "DATA PAGAMENTO",
	TO_CHAR(pag_referencia."VENCIMENTO", 'DD/MM/YYYY') AS "VENCIMENTO ATUAL"
FROM 
	cadastro.imovel imo
