...
(SELECT
	...
	TO_CHAR(valor_pago_parcelas.valor_pago,'999G999G990D00') AS "VALOR PAGO PARCELAS",
	TO_CHAR(((COALESCE(pagn.valor,0) + COALESCE(pagh.valor,0)) + valor_pago_parcelas.valor_pago),'999G999G990D00') AS "VALOR PAGO TOTAL"
FROM 
...
SELECT
	...
	TO_CHAR((COALESCE(pagn.valor,0) + COALESCE(pagh.valor,0)),'999G999G990D00') AS "VALOR PAGO TOTAL"
FROM 
