...
WHERE 
    os.orse_tmgeracao >= DATE '2025-01-01'
    AND usu_ence.usur_nmusuario IS DISTINCT FROM 'admin - GSAN'
    AND uno_geracao.unid_dsunidade IS DISTINCT FROM 'COORDENADORIA DE CADASTRO'
