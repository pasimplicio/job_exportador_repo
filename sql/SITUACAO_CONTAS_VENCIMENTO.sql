	SELECT
		...
		pag.pghi_dtpagamento - con.cnhi_dtvencimentooriginal AS "ATRASO VENCIMENTO",
		(CASE 
...
UNION
	SELECT
		...
		con.cnhi_dtvencimentoconta AS "VENCIMENTO",
		con.cnhi_dtvencimentooriginal AS "VENCIMENTO ORIGINAL",
		pag.pgmt_dtpagamento - con.cnhi_dtvencimentooriginal AS "ATRASO VENCIMENTO",
		(CASE 
...
UNION
	SELECT
		...
		pag.pghi_dtpagamento - con.cnta_dtvencimentooriginal AS "ATRASO VENCIMENTO",
		(CASE 
...
UNION
	SELECT
		...
		con.cnta_dtvencimentoconta AS "VENCIMENTO",
		con.cnta_dtvencimentooriginal AS "VENCIMENTO ORIGINAL",
		pag.pgmt_dtpagamento - con.cnta_dtvencimentooriginal AS "ATRASO VENCIMENTO",
		(CASE 
...
UNION
	SELECT
		...
		con.cnta_dtvencimentoconta AS "VENCIMENTO",
		con.cnta_dtvencimentooriginal AS "VENCIMENTO ORIGINAL",
		CURRENT_DATE - con.cnta_dtvencimentooriginal AS "ATRASO VENCIMENTO",
		(CASE 
...
UNION
	SELECT
		...
		con.cnhi_dtvencimentoconta AS "VENCIMENTO",
		con.cnhi_dtvencimentooriginal AS "VENCIMENTO ORIGINAL",
		COALESCE(par.parc_tmparcelamento::DATE, CURRENT_DATE) - con.cnhi_dtvencimentooriginal AS "ATRASO VENCIMENTO",
		(CASE 
		WHEN COALESCE(par.parc_tmparcelamento::DATE, CURRENT_DATE) - con.cnhi_dtvencimentoconta <= 0 THEN '01 - EM DIA'
		WHEN COALESCE(par.parc_tmparcelamento::DATE, CURRENT_DATE) - con.cnhi_dtvencimentoconta <= 5  THEN '02 - ATE 5 DIAS DE ATRASO'
		WHEN COALESCE(par.parc_tmparcelamento::DATE, CURRENT_DATE) - con.cnhi_dtvencimentoconta <= 15  THEN '03 - ATE 15 DIAS DE ATRASO'
		WHEN COALESCE(par.parc_tmparcelamento::DATE, CURRENT_DATE) - con.cnhi_dtvencimentoconta <= 30  THEN '04 - ATE 30 DIAS DE ATRASO'
		WHEN COALESCE(par.parc_tmparcelamento::DATE, CURRENT_DATE) - con.cnhi_dtvencimentoconta <= 60  THEN '05 - ATE 60 DIAS DE ATRASO'
		WHEN COALESCE(par.parc_tmparcelamento::DATE, CURRENT_DATE) - con.cnhi_dtvencimentoconta <= 90  THEN '06 - ATE 90 DIAS DE ATRASO'
		WHEN COALESCE(par.parc_tmparcelamento::DATE, CURRENT_DATE) - con.cnhi_dtvencimentoconta <= 180  THEN '07 - ATE 180 DIAS DE ATRASO'
		WHEN COALESCE(par.parc_tmparcelamento::DATE, CURRENT_DATE) - con.cnhi_dtvencimentoconta <= 365  THEN '08 - ATE 365 DIAS DE ATRASO'
		WHEN COALESCE(par.parc_tmparcelamento::DATE, CURRENT_DATE) - con.cnhi_dtvencimentoconta <= 1825  THEN '09 - ATE 5 ANOS DE ATRASO'
		WHEN COALESCE(par.parc_tmparcelamento::DATE, CURRENT_DATE) - con.cnhi_dtvencimentoconta <= 3650  THEN '10 - ATE 10 ANOS DE ATRASO'
		WHEN COALESCE(par.parc_tmparcelamento::DATE, CURRENT_DATE) - con.cnhi_dtvencimentoconta > 3650  THEN '11 - ACIMA DE 10 ANOS DE ATRASO'
		END) AS "FAIXA ATRASO",
		con.cnhi_nnconsumoagua AS "VOL AGUA",
		con.cnhi_nnconsumoesgoto AS "VOL ESGOTO",
		con.cnhi_vlagua AS "VL AGUA",
