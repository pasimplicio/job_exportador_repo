	...
	WHERE
		con.cnhi_dtvencimentooriginal >= '2020-10-01'
UNION
	SELECT
		imo.imov_id AS "MATRICULA",
		cli.clie_nmcliente AS "NOME",
...
UNION
	...
	FROM
		...
		LEFT JOIN cadastro.logradouro_tipo lgt ON lgt.lgtp_id = logr.lgtp_id
	WHERE
		con.cnta_dtvencimentooriginal >= '2020-10-01'
UNION
	SELECT
		imo.imov_id AS "MATRICULA",
		cli.clie_nmcliente AS "NOME",
...
UNION
	...
	FROM
		...
		LEFT JOIN cadastro.logradouro_tipo lgt ON lgt.lgtp_id = logr.lgtp_id
	WHERE
		con.cnta_dtvencimentooriginal >= '2020-10-01' AND 
...
UNION
	...
	FROM
		...
		LEFT JOIN cadastro.logradouro_tipo lgt ON lgt.lgtp_id = logr.lgtp_id
	WHERE
		con.cnhi_dtvencimentooriginal >= '2020-10-01' AND 
		con.dcst_idatual = 5