SELECT 
  ...
  cli.clie_nncpf AS "CPF ATUAL",
  cli.clie_nncnpj AS "CNPJ ATUAL",
--  cli.clie_dsemail AS "EMAIL ATUAL",
-- (
--	SELECT
...
--  ) AS "TELEFONES ATUAL",
--  TO_CHAR(cli.clie_dtnascimento,'dd/MM/yyyy') AS "DT NASCIMENTO ATUAL",
...
--  ra.imov_id AS "MATRICULA", 
  split_part(split_part(ra.rgat_dsobservacao, E'\n', 1),'- Nome: ',2) AS "NOME INFO",
  split_part(split_part(ra.rgat_dsobservacao, E'\n', 2),'- Cpf/Cnpj: ',2) AS "CPF/CNPJ INFO",
  split_part(split_part(ra.rgat_dsobservacao, E'\n', 3),'- Email: ',2) AS "EMAIL INFO",
  split_part(split_part(ra.rgat_dsobservacao, E'\n', 4),'- Telefone para Contato: ',2) AS "TELEFONE INFO",
  split_part(split_part(ra.rgat_dsobservacao, E'\n', 5),'Data de Nascimento: ',2) AS "DATA NASCIMENTO INFO",
