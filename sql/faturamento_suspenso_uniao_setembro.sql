...
faturamento_final AS (
    ...
    FROM (
	    ...
	    con.cnta_nnconsumoagua AS consumoagua,
            con.cnta_nnconsumoesgoto AS consumoesgoto,            
        ...
        SELECT 
            con.imov_id,
 	    con.cnhi_nnconsumoagua AS consumoagua,
            con.cnhi_nnconsumoesgoto AS consumoesgoto,             
...
SELECT 
    ...
    ff.consumoagua AS "CONSUMO AGUA",
    ff.consumoesgoto AS "CONSUMO ESGOTO",  
    -- Suspensões
