/*
lctp_id = 25 "TOTAL COBRADO NAS CONTAS"
lcit_id = 18 "TOTAL COBRADO NAS CONTAS"
-- VAR_REFERENCIA

*/
SELECT 
	--uneg.uneg_nmunidadenegocio AS "Nome Unidade",
	--greg.greg_nmregional AS "Gerencia Regional",
	--loca.loca_id AS "Localidade",
	--muni.muni_nmmunicipio AS "Municipio",
	--catg.catg_dscategoria AS "Categoria",
	--iper.iper_dsimovelperfil AS "Perfil Imovel",
	--rfat.rfat_amreferencia AS "Referencia",
	--rfat.rfat_dtcontabil AS "Data Faturamento",
	TO_CHAR(SUM(rfat.rfat_vlitemfaturamento), '999G999G990D00') AS "Valor Total Devido"
