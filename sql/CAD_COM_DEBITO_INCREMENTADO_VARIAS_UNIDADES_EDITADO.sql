--202607: Deve ser substituida pela referencia do faturamento que se deseja obter os dados
...
--	ban.bnco_nmbanco AS "NOME BANCO",
	...
	con_ult_fat.cagua AS "VOL AG 202607",
	TO_CHAR(con_ult_fat.vl_agua, '999G999G990D00') AS "VL AG 202607",
	con_ult_fat.cesg AS "VOL ES 202607",
	TO_CHAR(con_ult_fat.vl_esgoto, '999G999G990D00') AS "VL ES 202607",
	TO_CHAR(con_ult_fat.vl_debitos, '999G999G990D00') AS "OUTROS SERVICOS 202607",
	TO_CHAR(con_ult_fat.vl_creditos, '999G999G990D00') AS "CRED 202607",
	TO_CHAR(con_ult_fat.vl_impostos, '999G999G990D00') AS "IMPOSTOS 202607",
	TO_CHAR(con_ult_fat.valor, '999G999G990D00') AS "VALOR 202607",
	con_pen_fat.cagua AS "VOL AG 202607 - 1",
	TO_CHAR(con_pen_fat.vl_agua, '999G999G990D00') AS "VL AG 202607 - 1",
	con_pen_fat.cesg AS "VOL ES 202607 - 1",
	TO_CHAR(con_pen_fat.vl_esgoto, '999G999G990D00') AS "VL ES 202607 - 1",
	TO_CHAR(con_pen_fat.vl_debitos, '999G999G990D00') AS "OUTROS SERVICOS 202607 - 1",
	TO_CHAR(con_pen_fat.vl_creditos, '999G999G990D00') AS "CRED 202607 - 1",
	TO_CHAR(con_pen_fat.vl_impostos, '999G999G990D00') AS "IMPOSTOS 202607 - 1",
	TO_CHAR(con_pen_fat.valor, '999G999G990D00') AS "VALOR 202607 - 1",
	con_ant_fat.cagua AS "VOL AG 202607 - 2",
	TO_CHAR(con_ant_fat.vl_agua, '999G999G990D00') AS "VL AG 202607 - 2",
	con_ant_fat.cesg AS "VOL ES 202607 - 2",
	TO_CHAR(con_ant_fat.vl_esgoto, '999G999G990D00') AS "VL ES 202607 - 2",
	TO_CHAR(con_ant_fat.vl_debitos, '999G999G990D00') AS "OUTROS SERVICOS 202607 - 2",
	TO_CHAR(con_ant_fat.vl_creditos, '999G999G990D00') AS "CRED 202607 - 2",
	TO_CHAR(con_ant_fat.vl_impostos, '999G999G990D00') AS "IMPOSTOS 202607 - 2",
	TO_CHAR(con_ant_fat.valor, '999G999G990D00') AS "VALOR 202607 - 2",
	...
	TO_CHAR(pags_ult.valor, '999G999G990D00') AS "VALOR PAGO 202607",
	pags_ult.qtd AS "QTD DOC PAGOS 202607",
	TO_CHAR(pags_pen.valor, '999G999G990D00') AS "VALOR PAGO 202607 - 1",
	pags_pen.qtd AS "QTD DOC PAGOS 202607 - 1",
	TO_CHAR(pags_ant.valor, '999G999G990D00') AS "VALOR PAGO 202607 - 2",
	pags_ant.qtd AS "QTD DOC PAGOS 202607 - 2",
	CASE
		WHEN COALESCE(con_ult_fat.vl_agua,0)=0
		THEN TO_CHAR(fat_med.cagu_econ*imov_qteconomia, '999G999G990')
		ELSE ''
	END AS "POTENCIAL VOL AGUA ESTIMADO",
	CASE
		WHEN COALESCE(con_ult_fat.vl_agua,0)=0
		THEN TO_CHAR((fat_med.vlag_econ*imov_qteconomia),'999G999G990D00')
		ELSE ''
	END AS "POTENCIAL VALOR AGUA ESTIMADO",
	CASE
		WHEN COALESCE(con_ult_fat.vl_esgoto,0)=0
		THEN 
			CASE 
				WHEN COALESCE(fat_med.cesg_econ*imov_qteconomia,0) = 0
				THEN 
					CASE 
						WHEN 
							COALESCE(con_ult_fat.vl_agua,0) = 0
						THEN 
							TO_CHAR((fat_med.cagu_econ*imov_qteconomia),'999G999G990')
						ELSE
							TO_CHAR(con_ult_fat.cagua,'999G999G990')
					END
				ELSE
					TO_CHAR(fat_med.cesg_econ*imov_qteconomia,'999G999G990')
			END
		ELSE ''
	END AS "POTENCIAL VOL ESGOTO ESTIMADO",
	CASE
		WHEN COALESCE(con_ult_fat.vl_esgoto,0)=0
		THEN 
			CASE 
				WHEN COALESCE(fat_med.vles_econ*imov_qteconomia,0) = 0
				THEN 
					CASE
						WHEN
							COALESCE(con_ult_fat.vl_agua,0) = 0
						THEN
							TO_CHAR((fat_med.vlag_econ*imov_qteconomia),'999G999G990D00')
						ELSE
							TO_CHAR(con_ult_fat.vl_agua,'999G999G990D00')
					END
				ELSE
					TO_CHAR(fat_med.vles_econ*imov_qteconomia,'999G999G990D00')
			END
		ELSE ''
	END AS "POTENCIAL VALOR ESGOTO ESTIMADO",
	pag_referencia."ATRASO" AS "ATRASO FAT 202607 - 1",
	pag_referencia."DATA PAGAMENTO" AS "DATA PAGAMENTO FAT 202607 - 1",
	pag_referencia."VENCIMENTO" AS "VENCIMENTO FAT 202607 - 1",
	pag_referencia."VENCIMENTO ORIGINAL" AS "VENCIMENTO ORIGINAL FAT 202607 - 1",
	pag_referencia."ATRASO VENCIMENTO ORIGINAL" AS "ATRASO VENCIMENTO ORIGINAL FAT 202607 - 1",
	pag_referencia."FAIXA ATRASO" AS "FAIXA ATRASO FAT 202607 - 1",
	pag_referencia."VOL AGUA" AS "VOL AGUA FAT 202607 - 1",
	pag_referencia."VOL ESGOTO" AS "VOL ESGOTO FAT 202607 - 1",
	pag_referencia."VL AGUA" AS "VL AGUA FAT 202607 - 1",
	pag_referencia."VL ESGOTO" AS "VL ESGOTO FAT 202607 - 1",
	pag_referencia."VL DEBITOS" AS "VL DEBITOS FAT 202607 - 1",
	pag_referencia."VL CREDITOS" AS "VL CREDITOS FAT 202607 - 1",
	pag_referencia."VL IMPOSTOS" AS "VL IMPOSTOS FAT 202607 - 1",
	pag_referencia."VALOR" AS "VALOR FAT 202607 - 1",
	pag_referencia."STATUS" AS "STATUS FAT 202607 - 1"
FROM 
	cadastro.imovel imo
	...
	LEFT JOIN micromedicao.consumo_historico cosh_a1 ON cosh_a1.imov_id = imo.imov_id AND cosh_a1.cshi_amfaturamento = 202607 AND cosh_a1.lgti_id = 1
	...
	LEFT JOIN micromedicao.medicao_historico mdh ON mdh.hidi_id = his.hidi_id AND mdh.mdhi_amleitura = 202607
	...
	LEFT JOIN (	SELECT 
			...
			WHERE
				con4.cnta_amreferenciaconta = 202607
			UNION
			SELECT 
				con4.imov_id AS mat1,
			...
			FROM faturamento.conta_historico con4 
				INNER JOIN faturamento.conta_impressao cni ON cni.cnta_id = con4.cnta_id
			WHERE
				con4.cnhi_amreferenciaconta = 202607
			UNION
			SELECT 
				con4.imov_id AS mat1,
				con4.cnta_nnconsumoagua AS cagua,
	...
	LEFT JOIN (	SELECT 
			...
			WHERE
				con4.cnta_amreferenciaconta = (
					SELECT 
						CASE (CAST(SUBSTRING(CAST(202607 AS TEXT) FROM 5 FOR 6) AS INT))
							WHEN 1 THEN CAST((CAST(SUBSTRING(CAST(202607 AS TEXT) FROM 0 FOR 5) AS INT))-1 AS TEXT)||'12'
							ELSE CAST(202607-1 AS TEXT)
						END
				)
			UNION
			SELECT 
		...
		LEFT JOIN (	SELECT 
			...
			WHERE
				con4.cnta_amreferenciaconta = (
					SELECT 
						CASE (CAST(SUBSTRING(CAST(202607 AS TEXT) FROM 5 FOR 6) AS INT))
							WHEN 1 THEN CAST((CAST(SUBSTRING(CAST(202607 AS TEXT) FROM 0 FOR 5) AS INT))-1 AS TEXT)||'11'
							WHEN 2 THEN CAST((CAST(SUBSTRING(CAST(202607 AS TEXT) FROM 0 FOR 5) AS INT))-1 AS TEXT)||'12'
							ELSE CAST(202607-2 AS TEXT)
						END
				)
			UNION
			SELECT 
			...
			FROM		
				(SELECT 
					...
					WHERE
						...
						AND pag.pgmt_amreferenciaarrecadacao = 202607
					GROUP BY 1
				UNION
					SELECT 
						pag.imov_id AS imov_id,
					...
					WHERE
						pag.pgst_idatual IN (0,1)
						AND pag.pghi_amreferenciaarrecadacao = 202607
					GROUP BY 1) pags
			GROUP BY 1
...
WHERE
	...
	--AND imo.imov_id IN (146129,6699251)
	--AND dab.deba_dtinclusao IS NOT NULL
	--AND dab.deba_dtexclusao IS NOT NULL
