SELECT 
	DISTINCT con.imov_id AS "MATRICULA",
...
FROM
	...
	INNER JOIN cobranca.parcelamento par ON par.imov_id = con.imov_id
...
WHERE
	...
	AND con.cnta_dtvencimentoconta >= CURRENT_DATE - INTERVAL '24 months' AND con.cnta_dtvencimentoconta < CURRENT_DATE
