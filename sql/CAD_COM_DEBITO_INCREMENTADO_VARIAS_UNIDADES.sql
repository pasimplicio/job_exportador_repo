...
--	ban.bnco_nmbanco AS "NOME BANCO",
	...
	ctp.cltp_dsclientetipo AS "TIPO DE CLIENTE",
	(CASE ctp.cltp_icpessoafisicajuridica
	...
	logr.logr_id AS "CODIGO DO LOGRADOURO",
	...
	lesgt.lees_dsesgotamento AS "ESGOTAMENTO",	
...
--	
	LEFT JOIN cadastro.cliente_tipo ctp ON ctp.cltp_id = cli.cltp_id
--	
------
	LEFT JOIN atendimentopublico.lig_esgoto_esgotamento lesgt ON lesgt.lees_id = lesg.lees_id
------		
