...
set "COMANDO_FILE=%ROOT_DIR%\comando\COMANDO_MADRUGADA.csv"
...
if errorlevel 1 (
    echo.
    echo ERRO na execucao do projeto COMANDO_MADRUGADA
) else (
    echo.
    echo Projeto COMANDO_MADRUGADA gerado com sucesso.
)
endlocal
@pause
